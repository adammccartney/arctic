...
rhythm_definition.notes = [
        (sul_IV, abjad.Duration(1), arctic.time_signature("4/4"), arctic.tie()),
        (sul_IV, abjad.Duration(1), arctic.tie()),
        (sul_IV, abjad.Duration(1), arctic.tie()),
        (IV_fl_2, abjad.Duration(1), arctic.harmonic_mixed_on()),
        #----------------Bar 5
        (fifth_fl_trem_IV),
        ...
        #----------------Bar 13
        (sul_IV, abjad.Duration(1), arctic.default_on(), arctic.tie()),
        (sul_IV, abjad.Duration(1), arctic.tie()),
        ...
        ("r1"),
        ("r1"),
        (sul_II, abjad.Duration(1), arctic.tie(), arctic.default_on()),
        (sul_II, abjad.Duration(1), arctic.tie(), arctic.default_on()),
        #----------------Bar 21
        (sul_II, abjad.Duration(1), arctic.tie(), arctic.default_on()),
        (II_fl_2, abjad.Duration(1), arctic.harmonic_mixed_on()),
        (fifth_fl_trem_II),
        (II_fl_3, abjad.Duration(1), arctic.tie()),
        #----------------Bar 25
        (third_fl_trem_II),
        ...
        (sul_II, abjad.Duration(1), arctic.tie(), arctic.default_on()),
        (sul_II, abjad.Duration(1), arctic.tie()),
        #----------------Bar 33
        (sul_II, abjad.Duration(1), arctic.tie()),
        (sul_II, abjad.Duration(1), arctic.tie()),
        (sul_II, abjad.Duration(1), arctic.tie()),
        ...
        (empty_58_measure),
        ("r4"),
        (sul_III, abjad.Duration(3, 8), arctic.staccato()),
        ("r4"),
        (I_fl_2, abjad.Duration(3, 8), arctic.staccato(), 
                arctic.harmonic_mixed_on()),
        ("r4"),
        (III_fl_3, abjad.Duration(3, 8), arctic.staccato()),
        #----------------Bar 45
        ("r4"),
        (sul_I, abjad.Duration(3, 8), arctic.staccato(), arctic.default_on()),
        ("r4"),
        (III_fl_3, abjad.Duration(3, 8), arctic.staccato(), 
                arctic.harmonic_mixed_on()),
        ("r4"),
        ...
        ("r4"),
        (I_fl_3, abjad.Duration(3, 8), arctic.staccato(), 
                arctic.harmonic_mixed_on()),
        ("r4"),
        (I_fl_4, abjad.Duration(3, 8), arctic.staccato(),
                arctic.barline("||")),
   ]
...
rhythm_definition.markup = [
        ...
        (3, arctic.markup.sul_IV(), 5.5),
        (22, arctic.markup.flaut(), 1.5),
        (25, arctic.markup.sul_II(), 2.5),
        (50, arctic.markup.sul_III(), 2.5),
        (52, arctic.markup.sul_I(), 4.5),
        (54, arctic.markup.sul_III(), 5.5),
        (56, arctic.markup.sul_I(), 2.5),
        (58, arctic.markup.sul_III(), 4.5),
        (60, arctic.markup.sul_I(), 4.5),
        (62, arctic.markup.sul_III(), 6.5),
        (66, arctic.markup.sul_I(), 7.5),
        ]
...
rhythm_definition.notes = [
        ...
        (diad_four, abjad.Duration(1), arctic.tremolo(32), arctic.tie()),
        (diad_four, abjad.Duration(1), arctic.tremolo(32), arctic.tie()),
        (diad_four, abjad.Duration(1, 2), arctic.tremolo(32), arctic.tie()),
        (vln_sul_IV_double, abjad.Duration(1, 2), arctic.tremolo(32), arctic.tie()),
        #----------------Bar 5
        (vln_sul_IV_double, abjad.Duration(1), arctic.tremolo(32), arctic.tie()),
        (vln_sul_IV_double, abjad.Duration(1), arctic.tremolo(32), arctic.tie()),
        (vln_sul_IV_double, abjad.Duration(1), arctic.tremolo(32), arctic.tie()),
        (vln_sul_IV_double, abjad.Duration(1), arctic.tremolo(32), arctic.tie()),
        #----------------Bar 9
        ...
        (diad_four, abjad.Duration(1), arctic.tremolo(32), arctic.tie()),
        ("r1"),
        (diad_two, abjad.Duration(1), arctic.tremolo(32), arctic.tie()),
        (diad_two, abjad.Duration(1), arctic.tremolo(32), arctic.tie()),
        #----------------Bar 21
        (diad_two, abjad.Duration(1), arctic.tremolo(32), arctic.tie()),
        (diad_two, abjad.Duration(1, 2), arctic.tremolo(32), arctic.tie()),
        (vln_sul_II_double, abjad.Duration(1, 2), arctic.tremolo(32), arctic.tie()),
        (vln_sul_II_double, abjad.Duration(1), arctic.tremolo(32), arctic.tie()),
        (vln_sul_II_double, abjad.Duration(1), arctic.tremolo(32), arctic.tie()),
        #----------------Bar 25
        (vln_sul_II_double, abjad.Duration(1), arctic.tremolo(32), arctic.tie()),
        (vln_sul_II_double, abjad.Duration(1), arctic.tremolo(32), arctic.tie()),
