...
from arctic.tools.PhraseMaker import PhraseStream as PhraseStream
...
def make_diads(fuzzy_harmonies, interval_doubling=None):
    ...
    """
    from arctic.materials.pitch.definition import diatonic_register_lookup
...
def scale_range_double_octave(semitones):
    ...
    this is no problem for arctic, as they are being used to lookup
...
def transpose(fuzzy_harmonies, t_interval=0):
    ...
    """
    from arctic.materials.pitch.definition import transposition_lookup
...
#
 ...
 #       test_val += 1
    ...
    harmony = arctic.FuzzyHarmony('bf_ii', abjad.PitchSegment("ef' g' bf' c''"))
    second_harmony = arctic.FuzzyHarmony('g_v', abjad.PitchSegment("g' b' d' f'"))
